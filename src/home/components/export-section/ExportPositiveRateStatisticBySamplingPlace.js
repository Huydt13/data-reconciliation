...
const ExportPositiveRateStatisticBySamplingPlace = (props) => {
  ...
  const onSubmit = async (d) => {
    try {
      ...
      await dispatch(
        exportExcel({
          method: 'POST',
          url: apiLinks.excel.exportPositiveRateStatisticBySamplingPlaces,
          data: payload,
...
ExportPositiveRateStatisticBySamplingPlace.defaultProps = {
  code: 'TLD003',
};

ExportPositiveRateStatisticBySamplingPlace.propTypes = {
  code: PropTypes.string,
};

export default ExportPositiveRateStatisticBySamplingPlace;
