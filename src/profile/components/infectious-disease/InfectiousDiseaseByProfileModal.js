...
const InfectiousDiseaseByProfileModal = ({ data, onClose }) => {
...
InfectiousDiseaseByProfileModal.defaultProps = {
  data: undefined,
  onClose: () => { },
};

InfectiousDiseaseByProfileModal.propTypes = {
...
export default InfectiousDiseaseByProfileModal;
